...
export function readSettings(): WeatherSettings {
  ...
  return {
    ...
    nightEndHour: config.get<number>('nightEndHour', DEFAULT_SETTINGS.nightEndHour),
    nightStartHour: config.get<number>('nightStartHour', DEFAULT_SETTINGS.nightStartHour),
    ...
    winterStartMonth: config.get<number>('winterStartMonth', DEFAULT_SETTINGS.winterStartMonth),
    winterStartDay: config.get<number>('winterStartDay', DEFAULT_SETTINGS.winterStartDay),
    winterEndMonth: config.get<number>('winterEndMonth', DEFAULT_SETTINGS.winterEndMonth),
    winterEndDay: config.get<number>('winterEndDay', DEFAULT_SETTINGS.winterEndDay),
    cycleIntervalMin,
    cycleIntervalMax,
